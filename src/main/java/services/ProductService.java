...
public class ProductService {
        ...
        try (Statement stmt = connection.createStatement();
            ...
            while (rs.next()) {
                Product product = new Product(
                        ...
                        rs.getDouble("price"),
                        rs.getInt("stock"),
                        hasColumn(rs, "created_at") ? rs.getTimestamp("created_at") : null,
                        hasColumn(rs, "updated_at") ? rs.getTimestamp("updated_at") : null);
     ...
     * 
     * @param threshold The stock level threshold (products with stock < threshold
     *                  are returned)
    ...
    /**
     * Calculates the total monetary value of all inventory (price × stock for all
     * products)
     ...
     * 
     * @param action  The type of action performed (e.g., ADD_PRODUCT,
     *                UPDATE_PRODUCT)
